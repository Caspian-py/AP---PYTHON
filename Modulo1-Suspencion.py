...
causas_suspension = {
    "licencia por maternidad": {
        "tipo": "con goce",
        "descripcion": """Cuando una trabajadora está embarazada, tiene derecho a descansar antes y después del parto sin perder su sueldo ni su trabajo.
...
"""
    ...
    "licencia por paternidad": {
        "tipo": "con goce",
        "descripcion": """Si eres papá y acaba de nacer tu hijo o hija, tienes derecho a unos días de descanso pagado para estar con tu familia.
...
"""
    ...
    "licencia por adopcion": {
        "tipo": "con goce",
        "descripcion": """Si adoptas legalmente a un niño o niña, tienes derecho al mismo descanso que una madre biológica.
...
"""
    ...
    "licencia sindical (para dirigentes)": {
        "tipo": "con goce",
        "descripcion": """Si eres dirigente sindical, puedes ausentarte del trabajo para realizar tus actividades del sindicato.
...
"""
    ...
    "vacaciones anuales": {
        "tipo": "con goce",
        "descripcion": """Después de trabajar un año, tienes derecho a 30 días de descanso pagado.
...
"""
    ...
    "enfermedad comun o accidente": {
        "tipo": "sin goce",
        "descripcion": """Si te enfermas o sufres un accidente y no puedes trabajar, el empleador no te paga, pero puedes recibir un subsidio de EsSalud (si estás asegurado).
...
"""
    ...
    "licencia sin goce de haber": {
        "tipo": "sin goce",
        "descripcion": """Si necesitas tiempo para resolver asuntos personales (como viajar, estudiar, etc.), puedes pedir una licencia sin sueldo.
...
"""
    ...
    "huelga legal": {
        "tipo": "sin goce",
        "descripcion": """Si participas en una huelga que fue aprobada por la autoridad laboral, tu contrato se suspende.
...
"""
    ...
    "detencion preventiva": {
        "tipo": "sin goce",
        "descripcion": """Si estás detenido sin condena (por un juicio en proceso), tu contrato se suspende por un máximo de 3 meses.
...
"""
    ...
    "inhabilitacion judicial o administrativa": {
        "tipo": "sin goce",
        "descripcion": """Si te suspenden legalmente de ejercer tu profesión (por ejemplo, si pierdes la colegiatura o tienes una sanción judicial), no puedes trabajar.
...
"""
    ...
    "fuerza mayor o caso fortuito": {
        "tipo": "sin goce",
        "descripcion": """Cuando ocurren situaciones graves e imprevistas (terremoto, pandemia, incendio, etc.) que impiden seguir trabajando, la empresa puede pedir autorización para suspender los contratos.
...
"""
    ...
    "servicio militar obligatorio o reservista": {
        "tipo": "sin goce",
        "descripcion": """Si eres convocado al servicio militar o a la reserva del ejército, puedes ausentarte del trabajo.
...
def mostrar_causas():
    ...
    for id, causa in enumerate(causas_suspension):
